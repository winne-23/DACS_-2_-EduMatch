    ...
    <div class="Introduce_contents">
        <section class="hero is-info is-bold">
            <div class="hero-body has-text-centered">
                <p class="title">Liên hệ với EduMatch</p>
                ...
                <div class="columns is-centered">
                    <div class="column is-8">
                        <div class="info-box has-text-centered">
                            <p class="title is-4">
                                <i class="fas fa-phone info-icon"></i>Hotline
                            </p>
                            <p class="mb-4">0935.707.794</p>

                            <p class="title is-4">
                                <i class="fas fa-envelope info-icon"></i>Email
                            </p>
                            <p class="mb-4">thangtm.23it@vku.udn.vn</p>
                            ...
                            <div class="btn-group">
                                <a href="Form_gia_su.php" class="button is-primary is-medium">
                                    <i class="fas fa-user-plus mr-2"></i>Làm gia sư
                                </a>
                            </div>
                            <div class="btn-group">
                                <a href="Form_phu_huynh.php" class="button is-primary is-medium">
                                    <i class="fas fa-user-plus mr-2"></i>Tìm gia sư
                                </a>
                            </div>

                            <p class="mt-5 has-text-grey-dark">
                                Hoặc liên hệ qua các nền tảng xã hội:
                            </p>
                            <div class="icons mt-3">
                                <a href="https://www.facebook.com/tran.thang.453967/" class="icon is-large"><i
                                        class="fab fa-facebook fa-2x"></i></a>
                                <a href="https://www.instagram.com/okewinn.ne/" class="icon is-large"><i
                                        class="fab fa-instagram fa-2x"></i></a>
                                <a href="https://www.tiktok.com/@tranmanhthang07082005" class="icon is-large"><i
